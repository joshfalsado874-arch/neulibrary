...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  try {
    ...
    const role = data.userType || "-"; // <-- NEW
    const department = data.department || "-"; // <-- NEW
    const courseProgram = data.courseProgram || "-"; // <-- NEW
    ...
    visitorContainer.innerHTML = `
      ...
      <div class="detail-item"><i class="fas fa-user-tag"></i> Role: ${role}</div> <!-- NEW -->
      <div class="detail-item"><i class="fas fa-building"></i> Department: ${department}</div> <!-- NEW -->
      <div class="detail-item"><i class="fas fa-book"></i> Course / Program: ${courseProgram}</div> <!-- NEW -->
